...
class SearchViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        activityIndicator = NVActivityIndicatorView(frame: CGRect(x: self.view.frame.width / 2 - 30, y: self.view.frame.height / 2 - 30, width: 60, height: 60), type: .ballSpinFadeLoader, color: #colorLiteral(red: 0.9998469949, green: 0.4941213727, blue: 0.4734867811, alpha: 1), padding: nil)
    }
    ...
    @objc func textFieldDidChange (_ textField: UITextField) {
        ...
        if searchButtonOutlet.isEnabled {
            searchButtonOutlet.backgroundColor = #colorLiteral(red: 0.89, green: 0.2632301635, blue: 0.3486618854, alpha: 1)
        } else {
            disableSearchButton()
        }
